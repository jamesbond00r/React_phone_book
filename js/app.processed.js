...
/***/ (function(module, exports) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(ContactsList, { contacts: this.props.contacts })
	      );
	    }
	  }]);
	...
	var ContactsList = function (_React$Component2) {
	  _inherits(ContactsList, _React$Component2);

	  function ContactsList(props) {
	    _classCallCheck(this, ContactsList);

	    var _this2 = _possibleConstructorReturn(this, (ContactsList.__proto__ || Object.getPrototypeOf(ContactsList)).call(this, props));
	  ...
	  _createClass(ContactsList, [{
	    ...
	    value: function render() {
	      ...
	      var filteredContacts = this.state.contacts.filter(function (contact) {
	        return contact.name.toLowerCase().indexOf(_this3.state.search) !== -1;
	      });
	      return React.createElement(
	        'div',
	        null,
	        React.createElement('input', { type: 'text', placeholer: 'Search',
	        ...
	        React.createElement(
	          ...
	          filteredContacts.map(function (contact) {
	            return React.createElement(Contact, { contact: contact,
	              key: contact.id });
	          })
	        )
	      );
	...
	var Contact = function (_React$Component3) {
	  ...
	  return Contact;
		...
		ReactDOM.render(React.createElement(App, { contacts: contacts }), document.getElementById('app'));
